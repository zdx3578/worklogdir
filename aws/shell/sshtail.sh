...
echo -------------walk4---run
ssh -i  /Users/lmj/seoul.pem ubuntu@dpl.ren "ssh -i digits.pem ubuntu@b.dpl.ren 'tail work/modular_rl/nohup.out -n 600| grep RewP;  sleep 2; echo;echo; tail work/modular_rl-2p/nohup.out -n 500| grep -A2 EpLenMe ;  ' "|grep -vE "Ma|--"
echo;echo;
#echo -------------standup 620 7
#ssh -i  /Users/lmj/seoul.pem ubuntu@dpl.ren "ssh -i digits.pem ubuntu@c.dpl.ren 'tail work/modular_rl-2p/nohup.out -n 1000 |grep RewP ' "
